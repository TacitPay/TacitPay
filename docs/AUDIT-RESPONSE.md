...
1. Shielded wrapper ("Shield funds") → per-invoice settlement enforcement.
...
- **Pools don't cross by user action.** The faucet dispenses unshielded only
  ("rejects shielded and DUST addresses"), and the Wallet SDK offers no
