...
| 3:15 | **Say the limitation.** One sentence, unprompted: on today's public testnets the payment transfer itself is public — payer address and amount ride the open token flow, like cash handed over for a sealed envelope — while the invoice's contents never touch the ledger; the fully shielded flow already runs on the local devnet, and a contract-minted wrapper brings it to public networks in Wave 2. Volunteering this buys more credibility than hiding it costs.    |
